...
public class GenericDataReader implements Iterator<DataBlock>, Iterable<DataBlock>, Closeable{
	...
	private void init(SeekableInput sin) throws IOException,
		...
		String groupBundleStr = new String(header.meta.get(DataFileConstants.GROUP_BUNDLE), "UTF-8");
		String separator = new String(header.meta.get(DataFileConstants.GROUP_BUNDLE_SEPARATOR), "UTF-8");
		DataBlock.setGroupBundleAndDictAmount(new GroupBundle(groupBundleStr, separator));
