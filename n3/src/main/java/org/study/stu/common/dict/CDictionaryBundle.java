...
public class CDictionaryBundle {
	...
	private class Dictionary{
		...
		public void fromByteBuffer(ByteBuffer bb) throws IOException{
			...
			for (int i = 0; i < mapSize; i++){
				map.put(dataInput.readUTF(), dataInput.readInt());
			}
		}
	}
	...
	public ByteBuffer getByteBufferFromDict(int dictNum) throws IOException{
		return bundle.get(dictNum).toByteBuffer();
	}
